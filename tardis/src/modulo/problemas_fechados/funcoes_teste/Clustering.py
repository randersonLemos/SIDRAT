...
class Clustering(ProblemaFechadoPadrao):
    ...
    def __init__(self):
        ...
        self._necessidade = [EnumAtributo.PATH_RESULTADO] + super(Clustering, self).necessidade
        """
        Contem a lista de todos os atributos necessários para o módulo ser executado.
        """

        self._base_folder_name = f'base_CLUSTERING'
        """
        Variavel com o nome do arquivo
        """

        self._dominio_file_name = 'dominio_clusterizacao.txt'
        """
    ...
    def run(self, contexto: Contexto):
        ...
        """
        super(Clustering, self).run(contexto)
